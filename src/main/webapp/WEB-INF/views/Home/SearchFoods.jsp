...
<div class="products">
				...
				<div class="col-sm-6 col-sm-offset-3">
					<ul class="pagination">
						<c:forEach var="i" begin="1" end="${count }">
							...
							<c:if test="${page != i }">
								<li><a
									href="${pageContext.servletContext.contextPath}/SearchFoods?page=${i}&deptId=${deptId}&q=${q}">${i }</a></li>
							</c:if>
						</c:forEach>
					</ul>
				</div>
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									...
									<h6>${food.price}<sup>VND</sup>
									</h6>
									<form id="f${food.id.foodId }">
										<input type="hidden" name="departmentId"
											value="${food.id.departmentId }"> <input
											type="hidden" name="quantity" value="1"> <input
											type='hidden' name='image' value="${food.food.image }" /> <input
											type="hidden" name="product_name"
											value="${food.food.foodName }"> <input type="hidden"
											name="price" value="${food.price }">
										<button value="1" onclick="addToCart(${food.id.foodId})"
											type="button" class="w3ls-cart pw3ls-cart">
											<i class="fa fa-cart-plus" aria-hidden="true"></i> Add to
											cart
										</button>
										<span class="w3-agile-line"> </span> <a
											href="${pageContext.servletContext.contextPath}/DetailFood?foodId=${food.food.foodId}&deptId=${deptId}"
											data-target="#myModal1">More</a>
									</form>
								</div>
							</div>
						</div>
		...
		<div class="col-md-3 rsidebar">
			<div class="rsidebar-top">
				<div class="slider-left">
					<form method="GET"
						action="${pageContext.servletContext.contextPath}/SearchFoods">
						<input type="hidden" name="page" value="1" /> <input type="hidden"
							name="deptId" value="${deptId }" /> <input class="form-control"
							type="text" name="q" />
				...
				<div class="related-row">
					...
					<div class="galry-like">
						<a href="#" data-toggle="modal" data-target="#myModal1"><img
							src="images/s1.jpg" class="img-responsive" alt="img"></a>
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
	...
	<div class="container">
		<div class="w3agile-deals prds-w3text">
			<h5>Vestibulum maximus quam et quam egestas imperdiet. In
				dignissim auctor viverra.</h5>
		</div>
	</div>
	<!-- dishes -->
			...
			<div class="spldishes-agileinfo">
				<div class="col-md-3 spldishes-w3left">
					...
					<p>Vero vulputate enim non justo posuere placerat Phasellus
						mauris vulputate enim non justo enim .</p>
				</div>
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo"
						...
						<a href="products.html" class="item g1"> <img class="lazyOwl"
							src="images/g1.jpg" title="Our latest gallery" alt="" />
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						</a> <a href="products.html" class="item g1"> <img class="lazyOwl"
							src="images/g2.jpg" title="Our latest gallery" alt="" />
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						</a> <a href="products.html" class="item g1"> <img class="lazyOwl"
							src="images/g3.jpg" title="Our latest gallery" alt="" />
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						</a> <a href="products.html" class="item g1"> <img class="lazyOwl"
							src="images/g4.jpg" title="Our latest gallery" alt="" />
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						</a> <a href="products.html" class="item g1"> <img class="lazyOwl"
							src="images/g5.jpg" alt="" />
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right single-top-right">
							...
							<p>Proin placerat urna et consequat efficitur, sem odio
								blandit enim</p>
							...
							<p class="single-price-text">Fusce a egestas nibh, eget
								ornare erat. Proin placerat, urna et consequat efficitur, sem
								odio blandit enim, sit amet euismod turpis est mattis lectus.
								Vestibulum maximus quam et quam egestas imperdiet. In dignissim
								auctor viverra.</p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" /> <input
									type="hidden" name="add" value="1" /> <input type="hidden"
									name="w3ls_item" value="France Special" /> <input
							...
							<a href="#" class="w3ls-cart w3ls-cart-like"><i
								class="fa fa-heart-o" aria-hidden="true"></i> Add to Wishlist</a>
