					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<img src="${pageContext.servletContext.contextPath}/images/${food.key.image}" class="img-responsive" alt="img">
									<div class="agile-product-text">              
										<h5>${food.key.foodName }</h5>  
									</div> 
								</div>
								<div class="back">
									<h4>${food.key.foodName }</h4>
									
									<h6>${food.value}<sup>VND</sup></h6>
									<form action="#" method="post">
										...
										<a 
										href="${pageContext.servletContext.contextPath}/DetailFood?foodId=${food.key.foodId}&deptId=${deptId}" >
										More
										</a>
									</form>
								</div>
